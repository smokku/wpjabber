...
/* to store XML datas */
typedef int (*XdbSqlSetFunc) (struct XdbSqlDatas * self, const char *user,
			      xmlnode datas);

/* to load XML datas */
typedef xmlnode(*XdbSqlGetFunc) (struct XdbSqlDatas * self,
				 const char *user);
...
void _xdbsql_result_init(XdbSqlResult * res,
			 struct XdbSqlBackend *backend);
...
extern int xdbsql_auth_set(XdbSqlDatas * self, const char *user,
			   xmlnode data);

/* xdb_sql_authhash.c */
extern xmlnode xdbsql_authhash_get(XdbSqlDatas * self, const char *user);
extern int xdbsql_authhash_set(XdbSqlDatas * self, const char *user,
			       xmlnode data);
...
extern int xdbsql_vcard_set(XdbSqlDatas * self, const char *user,
			    xmlnode data);

/* xdb_sql_filter.c */
extern xmlnode xdbsql_filter_get(XdbSqlDatas * self, const char *user);
extern int xdbsql_filter_set(XdbSqlDatas * self, const char *user,
			     xmlnode data);

/* xdb_sql_roomconfig.c */
extern xmlnode xdbsql_roomconfig_get(XdbSqlDatas * self, const char *room);
extern int xdbsql_roomconfig_set(XdbSqlDatas * self, const char *room,
				 xmlnode data);

/* xdb_sql_roomoutcast.c */
extern xmlnode xdbsql_roomoutcast_get(XdbSqlDatas * self,
				      const char *room);
extern int xdbsql_roomoutcast_set(XdbSqlDatas * self, const char *room,
				  xmlnode data);

/* xdb_sql_generic.c */
extern xmlnode xdbsql_simple_get(XdbSqlDatas * self, query_def qd,
				 const char *user);
...
extern int xdbsql_offline_set(XdbSqlDatas * self, const char *user,
			      xmlnode data);
...
extern query_def xdbsql_querydef_init_v2(XdbSqlDatas * self, pool p,
					 xmlnode qd_root);
extern req_query_def xdbsql_reqquerydef_init(const query_def myqd,
					     const char *user);
...
extern query_def_bind_var xdbsql_reqquerydef_get_firstvar(req_query_def
							  rqd);
extern query_def_bind_var xdbsql_reqquerydef_get_nextvar(query_def_bind_var
							 var);
...
extern int xdbsql_register_set(XdbSqlDatas * self, const char *user,
			       xmlnode data);

/* xdb_sql_roster.c */
extern xmlnode xdbsql_roster_get(XdbSqlDatas * self, const char *user);
extern int xdbsql_roster_set(XdbSqlDatas * self, const char *user,
			     xmlnode roster);

/* xdb_sql_last.c */
extern xmlnode xdbsql_last_get(XdbSqlDatas * self, const char *user);
extern int xdbsql_last_set(XdbSqlDatas * self, const char *user,
			   xmlnode roster);
